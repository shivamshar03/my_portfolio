...
export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-20 max-w-7xl">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mx-4">
            {[
              ...
              { name: 'Flask & Django (Backend)', level: 85 },
              { name: 'MySQL / Database Management', level: 75 },
              { name: 'Next.js / React.js (Frontend)', level: 65 },
            ].map((skill, index) => (
              <div
                key={index}
      ...
      {/* Abhyudaya & Nexhub */}
      <section className="py-20 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-950">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto px-6">
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-2xl p-10 flex flex-col items-center transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-sky-800 dark:hover:shadow-sky-900">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-center mb-6 leading-relaxed max-w-md">
              Abhyudaya is the official student-led coding and innovation club at SVVV. As the founding president, I initiated a platform that encourages learning through real-world projects, expert workshops, and collaborative events — nurturing technical leadership and creative problem-solving.
            </p>
            <a
              href="https://abhyudaya-svvv.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center px-8 py-3 bg-sky-700 text-white rounded-full font-semibold shadow-lg hover:bg-sky-900 transition duration-300 focus:outline-none focus:ring-4 focus:ring-blue-300"
            >
              Visit Website
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-2xl p-10 flex flex-col items-center transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-violet-700 dark:hover:indigo-800">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-center mb-6 leading-relaxed max-w-md">
              NexHub is a fast-growing tech community dedicated to emerging technologies like AI, ML, automation, and developer growth. As the current Chairperson, I facilitate technical discussions, peer learning circles, networking meetups, and weekly events that bridge theory and practice.
            </p>
            <a
              href="https://nexhubcommunity.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center px-8 py-3 bg-indigo-600 text-white rounded-full font-semibold shadow-lg hover:bg-indigo-800 transition duration-300 focus:outline-none focus:ring-12 focus:ring-indigo-500"
            >
              Know More
              <svg className="ml-3 w-5 h-5 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path d="M17 8l4 4m0 0l-4 4m4-4H3" strokeLinecap="round" strokeLinejoin="round" />
